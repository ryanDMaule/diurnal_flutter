...
abstract final class Editions {
  static const library = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/default.png',
  ...
  static const atrium = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/library-white.png',
  ...
  static const foundry = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/abstract.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.20,
    gradientColors: [
      Color(0x000A0E10),
  ...
  static const ascent = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/ascent.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.38,
  ...
  static const hearth = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/cosy.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.16,
  ...
  static const reverie = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/dream.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.16,
  ...
  static const monolith = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/monolith.png',
  ...
  static const oak = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/oak.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.20,
    gradientColors: [
      Color(0x00160F0A),
  ...
  static const gilded = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/ornate.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.18,
    gradientColors: [
      Color(0x0014110E),
  ...
  static const palindrome = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/palindrome.png',
    tintColor: Color(0xFF000000),
    tintOpacity: 0.24,
  ...
  static const midnight = Edition(
    ...
    backgroundAsset: 'assets/images/editions/app/midnight.png',
